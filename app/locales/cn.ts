...
const cn = {
  WIP: "该功能仍在开发中……",
  Error: {
    Unauthorized: `第一次使用请点击[这里](/#/auth)输入访问秘钥 🔑`,
  },
  Auth: {
    Return: "返回",
    Title: "需要密码",
    Tips: "管理员开启了密码验证，请在下方填入访问码，然后点击确认",
    SubTips: "Or use your own OpenAI/Google API Key",
    Input: "在此处填写访问码",
    Confirm: "确认",
    Later: "稍后再说",
    SaasTips: "NextChat Ad",
    TopTips:
      "Deployed by PaperL",
  },
  ChatItem: {
